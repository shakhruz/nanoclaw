...
sqlite3 "$DB" "INSERT INTO scheduled_tasks (id, group_folder, chat_jid, prompt, schedule_type, schedule_value, next_run, status, created_at, context_mode) VALUES ('task-web-daily-domain-health-2026-04-23', 'telegram_main', 'tg:33823108', readfile('$PROMPTS_DIR/domain-health.txt'), 'cron', '30 9 * * *', '2026-04-24T09:30:00.000+05:00', 'active', '$NOW_ISO', 'isolated')"
